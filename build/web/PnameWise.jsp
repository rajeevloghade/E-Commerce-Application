...
<html>
    ...
    <body>
        <h2 class="ml-3"> Product Details</h2>
        <hr>
        <div class="row m-1">
            <%    while (rs.next()) {
            %>
                ...
                <form>
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <input type="text" readonly="true" value="<%=rs.getString(3)%> "class="form-control">
                        </div>

                        <div class="btn-group d-flex">
                            <button class="btn btn-success flex-fill" name="add"> Add to cart </button>
                            <button class="btn btn-warning flex-fill text-white" name="buy"> <a style="color: white" href=CartManager?Pcode=<%=rs.getString(1)%> >Buy Now</a> </button>
                        </div>
                    </div>
                    <br>
                </form>
        ...
        <div class="row ml-4"><br><a href="BuyerDash.jsp">Buyer-DashBoard</a></div>
    </body>
    <!-- Footer Starts-->
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12 footer-div text-center">
                    <div>
                        ...
                        <li><a href="BuyerDash.jsp">Buyer Dashboard</a></li>
