	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			while (rs.next()) {
				...
				out.println("<td><a href=DeleteUserOrder?Orderid=" + rs.getString(1) + ">Delete</a></td></tr>");
			}
			out.println("</table><hr>");
			out.println("</div>");
			out.println("</div><hr><div class='row m-1'><h3><a href='ViewAllUser'>All Users</a></h3><hr>");
